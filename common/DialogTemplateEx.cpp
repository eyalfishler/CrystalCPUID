...
/////////////////////////////////////////////////////////////////////////////
// __AfxConvertDialogUnitsToPixels

AFX_STATIC void AFXAPI __AfxConvertDialogUnitsToPixels(LPCTSTR pszFontFace, WORD wFontSize,
	int cxDlg, int cyDlg, SIZE* pSizePixel)
{
	...
	lstrcpyn(lf.lfFaceName, pszFontFace, _countof(lf.lfFaceName));
...
/////////////////////////////////////////////////////////////////////////////
// CDialogTemplateEx - implementation class

CDialogTemplateEx::CDialogTemplateEx(const DLGTEMPLATE* pTemplate)
{
	if (pTemplate == NULL)
	{
		m_hTemplate = NULL;
...
CDialogTemplateEx::CDialogTemplateEx(HGLOBAL hTemplate)
{
	if (hTemplate == NULL)
	{
		m_hTemplate = NULL;
...
BOOL CDialogTemplateEx::SetTemplate(const DLGTEMPLATE* pTemplate, UINT cb)
{
	m_dwTemplateSize = cb;
	...
	memcpy_s((BYTE*)pNew, (size_t)m_dwTemplateSize, 
		pTemplate, (size_t)m_dwTemplateSize);
...
CDialogTemplateEx::~CDialogTemplateEx()
{
	if (m_hTemplate != NULL)
		GlobalFree(m_hTemplate);
}

BOOL CDialogTemplateEx::Load(LPCTSTR lpDialogTemplateID)
{
...
HGLOBAL CDialogTemplateEx::Detach()
{
...
BOOL CDialogTemplateEx::HasFont() const
{
...
BYTE* AFX_CDECL CDialogTemplateEx::GetFontSizeField(const DLGTEMPLATE* pTemplate)
{
...
UINT AFX_CDECL CDialogTemplateEx::GetTemplateSize(const DLGTEMPLATE* pTemplate)
{
	BOOL bDialogEx = IsDialogEx(pTemplate);
...
BOOL AFX_CDECL CDialogTemplateEx::GetFont(const DLGTEMPLATE* pTemplate,
...
BOOL CDialogTemplateEx::GetFont(CString& strFace, WORD& nFontSize) const
{
...
BOOL CDialogTemplateEx::SetFont(LPCTSTR lpFaceName, WORD nFontSize)
{
	ASSERT(m_hTemplate != NULL);
	...
	{
		memmove_s(pNewControls, (size_t)(m_dwTemplateSize - (pOldControls - (BYTE*)pTemplate)), 
			pOldControls, (size_t)(m_dwTemplateSize - (pOldControls - (BYTE*)pTemplate)));
	}
...
BOOL CDialogTemplateEx::SetSystemFont(WORD wSize)
{
	LOGFONT lf;
...
void CDialogTemplateEx::GetSizeInDialogUnits(SIZE* pSize) const
{
	ASSERT(m_hTemplate != NULL);
...
void CDialogTemplateEx::GetSizeInPixels(SIZE* pSize) const
{
	ASSERT(m_hTemplate != NULL);
	ASSERT_POINTER(pSize, SIZE);
	...
	else
	{
		...
		__AfxConvertDialogUnitsToPixels(strFace, wSize, size.cx, size.cy, pSize);
	}
}
